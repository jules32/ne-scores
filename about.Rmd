...
## Assessing ocean health in the US Northeast
 
We are building a scientifically robust assessment of ocean health for the US Northeast. The OHI framework facilitates transparent and repeatable assessments of ocean health over time, and can be integrated into ongoing policy initiatives to support sustainable ocean management. We will build from previous OHI assessments and tailor the OHI framework to represent the cultural, social, and ecological characteristics and priorities of the US Northeast using the best available information and knowledge.

<br> 

This website will serve as a communication platform as we work so that we can share the process as well as final results. Our code is available [here](https://github.com/OHI-Science/ohi-northeast).
