...
## Extent 4 (Northeast region)
ext_4 <- wgs_ext
vs_mass_ext4 <- crop(vs_stack[['vansebillemodel_mass']], wgs_ext)
plot(vs_mass_ext4, col=cols, axes=F, main = "OHI NE extent")
plot(world,col='gray',add=T)
...
map_scores(data,'pressure_score',scale_label = "Clean Waters Trash Pressure", map_title = "")
```
