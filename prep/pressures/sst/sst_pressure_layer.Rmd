...
diffs <- list.files('int/sst_anom_diffs',full.names=T)
...
#mclapply(diffs,local_resc,mc.cores = 10)
lapply(diffs,local_resc)
...
}, movie.name = 'sst_anom_diffs_rescale.gif') #this cause an error on local comp. try on server
...
A static ggplot for scores over time
