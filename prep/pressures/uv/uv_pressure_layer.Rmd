...
raw_data_dir = file.path(dir_M,'git-annex/globalprep/_raw_data/NASA_OMI_AURA_UV/d2017')
...
lapply(anom_files[5:8],crop_to_ne)
...
registerDoParallel(5) #set 5 cores to do parallel processing
...
foreach(i = c(2005:2012)) %dopar% { #i=2005
  ...
  writeRaster(diff,filename = paste0('int/annual_diff_ocean_',yrs[1],'_',yrs[5],'.tif'),overwrite=T)
