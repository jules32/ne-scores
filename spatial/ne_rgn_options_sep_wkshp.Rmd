...
writeOGR(epu_ext, dsn = ".", layer = "epu_extended", driver = "ESRI Shapefile")
```
...
ggplot() +
  ...
  geom_sf(data = ne_roi,aes(fill = region))+
...
ggplot() +
  ...
  geom_sf(data = ne_roi,aes(fill = region),alpha = 0, lwd = 0.5)+
  theme_bw()+
  ggtitle("Option 2")+ 
  labs(fill='Regions') +
